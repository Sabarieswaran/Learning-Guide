...
description: A structured beginner learning path — from HTML basics to your first Angular application.
---
...
```mermaid
flowchart LR
    A[HTML] -->|2 weeks| B[CSS]
    B -->|3 weeks| C[JavaScript]
    C -->|3 weeks| D[TypeScript]
    D -->|4 weeks| E[Angular Basics]
```
